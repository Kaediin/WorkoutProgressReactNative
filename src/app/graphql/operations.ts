...
export type ScheduledProgramFragment = { __typename?: 'ScheduledProgram', id: string, scheduledDateTime: any, program: { __typename?: 'Program', id: string, name: string, createdDateTime: any, active: boolean, remark?: string | null }, workout: { __typename?: 'Workout', id: string, name: string, muscleGroups: Array<MuscleGroup>, startDateTime?: any | null, endDateTime?: any | null, active?: boolean | null, remark?: string | null, estimatedCaloriesBurned?: number | null, status: WorkoutStatus } };
...
export type ScheduleProgramMutation = { __typename?: 'Mutation', scheduleProgram: { __typename?: 'ScheduledProgram', id: string, scheduledDateTime: any, program: { __typename?: 'Program', id: string, name: string, createdDateTime: any, active: boolean, remark?: string | null }, workout: { __typename?: 'Workout', id: string, name: string, muscleGroups: Array<MuscleGroup>, startDateTime?: any | null, endDateTime?: any | null, active?: boolean | null, remark?: string | null, estimatedCaloriesBurned?: number | null, status: WorkoutStatus } } };
...
export type UpdateScheduledProgramMutation = { __typename?: 'Mutation', updateScheduledProgram: { __typename?: 'ScheduledProgram', id: string, scheduledDateTime: any, program: { __typename?: 'Program', id: string, name: string, createdDateTime: any, active: boolean, remark?: string | null }, workout: { __typename?: 'Workout', id: string, name: string, muscleGroups: Array<MuscleGroup>, startDateTime?: any | null, endDateTime?: any | null, active?: boolean | null, remark?: string | null, estimatedCaloriesBurned?: number | null, status: WorkoutStatus } } };
...
export type AdjustLogAndMarkAsCompletedMutationVariables = Exact<{
  id: Scalars['ID'];
  input: ProgramLogInput;
  workoutId: Scalars['String'];
  zonedDateTimeString: Scalars['String'];
...
export type AdjustLogAndMarkAsCompletedMutation = { __typename?: 'Mutation', adjustLogAndMarkAsCompleted: { __typename?: 'ProgramLog', id?: string | null, effort?: number | null, repetitions: number, intervalSeconds?: number | null, cooldownSeconds?: number | null, programLogGroup?: { __typename?: 'ProgramLogGroup', id: string } | null, exercise?: { __typename?: 'Exercise', id: string, name: string, primaryMuscles?: Array<MuscleGroup | null> | null, secondaryMuscles?: Array<MuscleGroup | null> | null, notes?: string | null, defaultAppliedWeight?: { __typename?: 'LogValue', unit: LogUnit, base: number, fraction?: number | null } | null } | null, logValue: { __typename?: 'LogValue', unit: LogUnit, base: number, fraction?: number | null }, subdivisions?: Array<{ __typename?: 'ProgramLog', repetitions: number, effort?: number | null, intervalSeconds?: number | null, cooldownSeconds?: number | null, programLogGroup?: { __typename?: 'ProgramLogGroup', id: string } | null, logValue: { __typename?: 'LogValue', unit: LogUnit, base: number, fraction?: number | null }, exercise?: { __typename?: 'Exercise', id: string, name: string, primaryMuscles?: Array<MuscleGroup | null> | null, secondaryMuscles?: Array<MuscleGroup | null> | null, notes?: string | null, defaultAppliedWeight?: { __typename?: 'LogValue', unit: LogUnit, base: number, fraction?: number | null } | null } | null, exerciseLog?: { __typename?: 'ExerciseLog', id: string, logDateTime: any, repetitions: number, warmup?: boolean | null, remark?: string | null, effort?: number | null, exercise: { __typename?: 'Exercise', id: string, name: string, primaryMuscles?: Array<MuscleGroup | null> | null, secondaryMuscles?: Array<MuscleGroup | null> | null, notes?: string | null, defaultAppliedWeight?: { __typename?: 'LogValue', unit: LogUnit, base: number, fraction?: number | null } | null }, logValue: { __typename?: 'LogValue', unit: LogUnit, base: number, fraction?: number | null }, workout: { __typename?: 'Workout', id: string } } | null }> | null, exerciseLog?: { __typename?: 'ExerciseLog', id: string, logDateTime: any, repetitions: number, warmup?: boolean | null, remark?: string | null, effort?: number | null, exercise: { __typename?: 'Exercise', id: string, name: string, primaryMuscles?: Array<MuscleGroup | null> | null, secondaryMuscles?: Array<MuscleGroup | null> | null, notes?: string | null, defaultAppliedWeight?: { __typename?: 'LogValue', unit: LogUnit, base: number, fraction?: number | null } | null }, logValue: { __typename?: 'LogValue', unit: LogUnit, base: number, fraction?: number | null }, workout: { __typename?: 'Workout', id: string } } | null } };
...
export type MyScheduledProgramQuery = { __typename?: 'Query', myScheduledPrograms?: Array<{ __typename?: 'ScheduledProgram', id: string, scheduledDateTime: any, program: { __typename?: 'Program', id: string, name: string, createdDateTime: any, active: boolean, remark?: string | null }, workout: { __typename?: 'Workout', id: string, name: string, muscleGroups: Array<MuscleGroup>, startDateTime?: any | null, endDateTime?: any | null, active?: boolean | null, remark?: string | null, estimatedCaloriesBurned?: number | null, status: WorkoutStatus } }> | null };
...
export const AdjustLogAndMarkAsCompletedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"adjustLogAndMarkAsCompleted"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ProgramLogInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"workoutId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"zonedDateTimeString"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"adjustLogAndMarkAsCompleted"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}},{"kind":"Argument","name":{"kind":"Name","value":"workoutId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"workoutId"}}},{"kind":"Argument","name":{"kind":"Name","value":"zonedDateTimeString"},"value":{"kind":"Variable","name":{"kind":"Name","value":"zonedDateTimeString"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProgramLog"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Exercise"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Exercise"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"primaryMuscles"}},{"kind":"Field","name":{"kind":"Name","value":"secondaryMuscles"}},{"kind":"Field","name":{"kind":"Name","value":"defaultAppliedWeight"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LogValue"}}]}},{"kind":"Field","name":{"kind":"Name","value":"notes"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ExerciseLog"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ExerciseLog"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"exercise"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"Exercise"}}]}},{"kind":"Field","name":{"kind":"Name","value":"logDateTime"}},{"kind":"Field","name":{"kind":"Name","value":"repetitions"}},{"kind":"Field","name":{"kind":"Name","value":"logValue"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LogValue"}}]}},{"kind":"Field","name":{"kind":"Name","value":"warmup"}},{"kind":"Field","name":{"kind":"Name","value":"remark"}},{"kind":"Field","name":{"kind":"Name","value":"workout"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"effort"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LogValue"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LogValue"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unit"}},{"kind":"Field","name":{"kind":"Name","value":"base"}},{"kind":"Field","name":{"kind":"Name","value":"fraction"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ProgramLog"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProgramLog"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"programLogGroup"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"effort"}},{"kind":"Field","name":{"kind":"Name","value":"exercise"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"Exercise"}}]}},{"kind":"Field","name":{"kind":"Name","value":"logValue"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LogValue"}}]}},{"kind":"Field","name":{"kind":"Name","value":"repetitions"}},{"kind":"Field","name":{"kind":"Name","value":"subdivisions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"programLogGroup"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"repetitions"}},{"kind":"Field","name":{"kind":"Name","value":"logValue"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LogValue"}}]}},{"kind":"Field","name":{"kind":"Name","value":"effort"}},{"kind":"Field","name":{"kind":"Name","value":"exercise"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"Exercise"}}]}},{"kind":"Field","name":{"kind":"Name","value":"intervalSeconds"}},{"kind":"Field","name":{"kind":"Name","value":"cooldownSeconds"}},{"kind":"Field","name":{"kind":"Name","value":"exerciseLog"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ExerciseLog"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"intervalSeconds"}},{"kind":"Field","name":{"kind":"Name","value":"cooldownSeconds"}},{"kind":"Field","name":{"kind":"Name","value":"exerciseLog"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ExerciseLog"}}]}}]}}]} as unknown as DocumentNode;
export type AdjustLogAndMarkAsCompletedMutationFn = Apollo.MutationFunction<AdjustLogAndMarkAsCompletedMutation, AdjustLogAndMarkAsCompletedMutationVariables>;

/**
 * __useAdjustLogAndMarkAsCompletedMutation__
 *
 * To run a mutation, you first call `useAdjustLogAndMarkAsCompletedMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAdjustLogAndMarkAsCompletedMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [adjustLogAndMarkAsCompletedMutation, { data, loading, error }] = useAdjustLogAndMarkAsCompletedMutation({
 *   variables: {
 *      id: // value for 'id'
 *      input: // value for 'input'
 *      workoutId: // value for 'workoutId'
 ...
 * });
 */
export function useAdjustLogAndMarkAsCompletedMutation(baseOptions?: Apollo.MutationHookOptions<AdjustLogAndMarkAsCompletedMutation, AdjustLogAndMarkAsCompletedMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AdjustLogAndMarkAsCompletedMutation, AdjustLogAndMarkAsCompletedMutationVariables>(AdjustLogAndMarkAsCompletedDocument, options);
      }
export type AdjustLogAndMarkAsCompletedMutationHookResult = ReturnType<typeof useAdjustLogAndMarkAsCompletedMutation>;
export type AdjustLogAndMarkAsCompletedMutationResult = Apollo.MutationResult<AdjustLogAndMarkAsCompletedMutation>;
export type AdjustLogAndMarkAsCompletedMutationOptions = Apollo.BaseMutationOptions<AdjustLogAndMarkAsCompletedMutation, AdjustLogAndMarkAsCompletedMutationVariables>;
